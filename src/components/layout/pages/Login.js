        ...
        <form onSubmit={(e) => handleSubmit(e)}>
          <table align='center' className='table'>
            ...
            <tr>
              ...
              <td 
             // style={{background:'green',paddingLeft:"10px",textAlign:"center"}}
              ><i className={showPassword ? "fa fa-eye-slash" :" fa fa-eye "   }
              style={{background:'inherit',paddingLeft:"10px",textAlign:"center"
                ,marginBottom:"10px",color:"green",fontSize:"20px"
              }}
